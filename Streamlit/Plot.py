...
df = pd.read_csv("C:/Users/ashis/OneDrive - Lovely Professional University/Documents/Gfg/Streamlit/files/lang_data.csv")
lang_list = df.columns.tolist()
lang_choises = st.multiselect('Choose your language',lang_list)
new_df = df[lang_choises]
